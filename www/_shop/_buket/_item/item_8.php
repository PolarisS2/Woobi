...
<body>
    ...
    <div id="container">
        <div>
            <div id="item_img">
                <img src="//cheat-key.com/web/product/medium/202205/3450f2898870322b00c8534b96170aef.jpg" class="card-img-top" alt="준비중입니다">
            </div>
            
            <form action="../buket.php" method="post">
                <div id="item_img_text">
                    <p><strong>[1+1+1+1+1] 피넛 링클프리 반팔 티셔츠</strong></p>
                    <input name="product" type="hidden" readonly value="[1+1+1+1+1] 피넛 링클프리 반팔 티셔츠">
                    <p>가격 : 16,900원</p>
